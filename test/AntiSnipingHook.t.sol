...
contract TestGasPriceFeesHook is Test, Deployers {
    ...
    function test_swapFeesSnipingPrevention() public {
        ...
        vm.roll(2);
        // Bob sees a juicy donation in the mempool and decides to snipe it - Bob deposit his liquidity right before the donation happens
        vm.prank(bob);
        modifyLiquidityRouter.modifyLiquidity(
            key,
            IPoolManager.ModifyLiquidityParams({
        ...
        // Bob accrued half of the fees generated by the donations right after creating his position
        uint256 errorAllowed = 0.00001e18; // 0.0001%
        assertApproxEqRel(hook.firstBlockFeesToken0(poolId, bobPositionKey), token0Donation / 2, errorAllowed);
        assertApproxEqRel(hook.firstBlockFeesToken1(poolId, bobPositionKey), token1Donation / 2, errorAllowed);
        ...
        // Bob should have not received any fees
        assertApproxEqRel(bobToken0BalanceAfter, bobToken0BalanceBefore, errorAllowed);
        assertApproxEqRel(bobToken1BalanceAfter, bobToken1BalanceBefore, errorAllowed);
        ...
        // Alice should have received all of the donation fees
        assertApproxEqRel(aliceToken0BalanceAfter, aliceToken0BalanceBefore + token0Donation, errorAllowed);
